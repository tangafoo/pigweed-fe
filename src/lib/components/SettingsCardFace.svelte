...
>
	...
	>
		...
		>
			<span class="flex items-center gap-1.5 font-oswald text-xs font-bold tracking-[0.2em] uppercase">
			...
			<div class="min-w-0 flex-1">
				<div class="flex items-center gap-2">
					...
					<span class="flex items-center gap-1 font-oswald text-sm text-olf-darkbrown/60">
						...
						{#if rerollMsg}
							<span in:fade={{ duration: 150 }} class="font-oswald text-xxs font-bold text-olf-yolk">
								{rerollMsg}
							</span>
						{/if}
					</span>
		...
		<div class="grid flex-1 grid-cols-3 gap-3 px-5 pb-2 font-oswald">
			...
			<section class="flex flex-col gap-2">
				...
				<div class="flex flex-col">
					<span class="flex items-center gap-1 text-[9px] tracking-[0.15em] text-olf-darkbrown/55 uppercase">
				...
				<div class="flex flex-col">
					<span class="flex items-center gap-1 text-[9px] tracking-[0.15em] text-olf-darkbrown/55 uppercase">
						...
						<span class="group relative inline-flex">
							...
							<span
								role="tooltip"
								class="pointer-events-none absolute bottom-5 right-0 z-20 hidden w-52 rounded-xl border border-olf-darkbrown/15 bg-white p-3 text-xs leading-snug font-medium normal-case shadow-xl group-focus-within:block group-hover:block"
							>
